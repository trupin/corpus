...
/**
 * The projection's maintenance surface (SPEC.md §14). Both verbs go over HTTP
...
export const dbTopic: TopicSpec = {
  ...
  description:
    ...
    "and “rebuild then a clean doctor” is the standing invariant §14 gates v1 on. Neither verb " +
