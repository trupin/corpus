  ...
  return (
    <div
      ...
      onContextMenu={(event) => {
        ...
        // Plugin-*rendered* surfaces keep the browser's menu (sign-off item 4),
        // and `keepsNativeMenu` is where that rule lives — `[data-plugin-surface]`
        // is one of its hosts. This list is core's own, so nothing here is one;
