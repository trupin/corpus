...
| Flag                        | Type                | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------------------- | ------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `--type <type>`             | string              | —       | Document type: `note`, `view`, `template`, `skill`, `agent-def`, or any other value this workspace uses (SPEC.md §5 — the field is an open string). Required.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `--pinned <true\|false>`    | string              | —       | Pin this document to the board as a column, or unpin it (SPEC.md §10 — **a column IS a `type: view` document with `pinned: true`**). Takes an explicit value, like `--evergreen`: omitting the flag leaves the field alone, `--pinned false` removes the column. The board picks the change up over SSE with no reload. Note this is the **write** side of `doc list --pinned`, which is a filter and therefore a plain boolean.                                                                                                                                                                                                                                                                                                           |
...
| `--author <user\|agent>`    | string  | —       | Author of the thread's last turn. Thread-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `--unread`                  | boolean | `false` | Only threads whose last turn is newer than your last-seen mark. Thread-only, and it selects the unread side only — there is no flag for the read side.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `--pinned`                  | boolean | `false` | Only documents pinned to the board as columns (SPEC.md §10) — in practice `type: view` documents. Selects the pinned side only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
The human rendering is a summary: the whole payload — including the §10 view keys and any non-core `extra` frontmatter — is what `--json` emits, unchanged. An id that names no document is the server's `404`, which is exit 5.
