...
If there's a `SPEC.md`, check whether this feature is already specified or conflicts with existing specs.
...
1. **Update `SPEC.md`** if the feature introduces new behavior (add stubs with `[TBD: ISSUE-ID]` markers).
