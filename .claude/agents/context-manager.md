...
If information is already in `issues/PLAN.md`, `SPEC.md`, or issue files, don't repeat it. Just reference it: "See PLAN.md for current state." Only capture what would be LOST without the handoff.
