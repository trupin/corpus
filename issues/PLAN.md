...
| CONTRACT-063 | `MoveDocRequest.folder` is required and still says it defaults to `inbox` | todo | P2 | CONTRACT-062 |
...
| AGENT-034 | A skill that creates an agent profile | todo | P0 | SERVER-122, CLI-050 |
