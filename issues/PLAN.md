...
This deliberately revokes two standing doctrines, which is why SHARED-043 gates
everything: §7's single-consumer assumption becomes **one consumer per lane**, and
"queue state never crosses the subagent boundary" becomes **a lane's owner settles
its own lane**. Fallback keeps the revocation safe: presence is the parked scoped
`idle`, and a lane whose listener lapses falls back to the orchestrator at claim
time — slower, never silent, nothing rewritten.

Provenance (CONTRACT-050/SERVER-106/CLI-042) is the load-bearing first step and is
...
| SERVER-106 | Stamp a document with the thread it came from | todo | P0 | CONTRACT-050 |
| SERVER-109 | Designate a resident, and dissolve it cleanly | todo | P0 | CONTRACT-051 |
| SERVER-107 | The queue learns lanes | todo | P0 | CONTRACT-051, SERVER-106, SERVER-109 |
| SERVER-108 | Presence is a parked request — liveness and the roster | todo | P0 | SERVER-107 |
| CLI-042 | Mutating verbs carry the job they serve | todo | P0 | CONTRACT-050, SERVER-106 |
| CLI-043 | Lane verbs, designation, and `corpus agents` | todo | P0 | CONTRACT-051, SERVER-107, SERVER-108, SERVER-109 |
| AGENT-025 | The converse skill — a resident's own loop | todo | P0 | SHARED-043, CLI-042, CLI-043 |
