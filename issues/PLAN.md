...
| SERVER-144 | Retrieval ranks the product's own skills into every pack | done | P1 | opus | SHARED-070 |
...
| CLI-068 | `queue claim-all` inside a batch loses its payload, silently (AGENT-051 finding) | todo | P0 | opus | CLI-064 |
