...
## Spec References
- SPEC.md **§1** — *"a domain gets its shape from the templates, views and skills a workspace holds"* (SHARED-064)
...
SHARED-064's replacement premise says a domain *"gets its shape from the
