...
| **145** | `db rebuild && db doctor` at the end of the loop | exit 0, `{"ok":true,"drift":[],…}` — §14's standing invariant holds on a workspace that went through every mutation this sprint added | PASS |
