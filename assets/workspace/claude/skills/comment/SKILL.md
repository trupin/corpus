...
Write `/tmp/corpus-title-th_9f21c4.txt`, named for its thread, with your file-writing tool:
...
```bash
corpus doc edit th_9f21c4 --flag-file title=/tmp/corpus-title-th_9f21c4.txt --from agent
```
