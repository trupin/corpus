...
into the flag. Write `/tmp/corpus-description-weekly-review.txt` — named for the skill it
...
```bash
corpus skill create weekly-review --flag-file description=/tmp/corpus-description-weekly-review.txt --from agent <<'CORPUS_EOF'
# Weekly review
